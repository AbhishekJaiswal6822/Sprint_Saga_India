...
function RaceCategories({ onRegister = (title) => alert(`Register clicked for ${title}`) }) {
  return (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {categories.map(({ id, Icon, title, price }) => (
            ...
            >
              ...
              <h3 id={`cat-${id}-title`} className="text-lg font-semibold text-slate-800 mb-3">
                {title}
              </h3>
              ...
              <button
                ...
                className="inline-block px-4 py-2 rounded-full border border-slate-200 text-slate-700 hover:bg-slate-100 transition focus:outline-none focus:ring-2 focus:ring-teal-200"
...
/* small helper to pick icon color + soft bg */
