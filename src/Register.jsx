...
const raceCategories = [
  ...
  },
  {
    id: "half",
    name: "Half Marathon",
    description: "The classic distance",
    price: 45,
  },
  {
    id: "35k",
  ...
  },
  {
    id: "50k",
    name: "50K Ultra",
    description: "For the elite runners",
    price: 85,
  },
];
...
function Register() {
  ...
  if (registrationType === "group") {
    ...
    // Example discount if 3 or more members (just UI demo)
    if (memberCount >= 3) {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // For now just prevent refresh. You can add your actual submit logic here.
      ...
      <section className="max-w-6xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-10">
          ...
          <p className="mt-3 text-slate-600">
            Choose your registration type and complete your details
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-slate-100 p-6 md:p-8">
            ...
            <p className="text-sm text-slate-500 mt-1">
              Choose between individual or group registration
            </p>
            ...
            <div className="mt-5 bg-slate-50 rounded-full p-1 flex text-sm font-medium border border-slate-100">
              ...
              >
                <span className="inline-flex h-6 w-6 items-center justify-center rounded-full border border-slate-200">
                  <span className="i-heroicons-user text-xs" />
                </span>
              ...
              >
                <span className="inline-flex h-6 w-6 items-center justify-center rounded-full border border-slate-200">
                  <span className="i-heroicons-users text-xs" />
                </span>
            ...
            {registrationType === "individual" ? (
              <div className="mt-6 rounded-2xl border border-slate-100 bg-slate-50 px-5 py-4 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600 mt-1">
                    Register yourself for the marathon
                  </p>
                </div>
              </div>
            ) : (
              <div className="mt-6 rounded-2xl border border-slate-100 bg-slate-50 px-5 py-4 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600 mt-1">
                    Register multiple participants together (minimum 3 members
                    for group discount)
                  </p>
                </div>
              </div>
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-slate-100 p-6 md:p-8">
            ...
            <p className="text-sm text-slate-500 mt-1">
              Select the distance that matches your fitness level and goals
            </p>
              ...
              {raceCategories.map((race) => {
                ...
                return (
                  <button
                    ...
                    className={`cursor-pointer relative w-full text-left rounded-2xl border px-5 py-4 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2 ${
                      isSelected
                        ? "border-teal-500 bg-cyan-50 shadow-sm"
                  ...
                  >
                    ...
                    {isSelected && (
                      <div className="mt-3 flex items-center gap-2 text-xs font-medium text-teal-700">
                        <span className="inline-flex h-5 w-5 items-center justify-center rounded-full bg-teal-600 text-white text-[10px]">
                          ✓
                        </span>
                        <span>Selected</span>
                      </div>
          ...
          {registrationType === "group" && (
            <div className="bg-white rounded-3xl shadow-sm border border-slate-100 p-6 md:p-8">
              ...
              <p className="text-sm text-slate-500 mt-1">
                Enter details for all group members (minimum 3 for group
                discount)
              </p>
              ...
              <div className="mt-6 grid md:grid-cols-[2fr,1fr,auto] gap-4 items-end">
                ...
                <div className="flex md:justify-end">
                  <button
                    ...
                    className="inline-flex items-center rounded-xl bg-teal-600 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-teal-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 focus-visible:ring-offset-2"
                  >
                    Add Member
                  </button>
                </div>
              ...
              <div className="mt-6 space-y-6 rounded-2xl border border-dashed border-slate-200 bg-slate-50/60 p-4 md:p-5">
                {groupMembers.map((member, index) => (
                  <div
                    key={index}
                    className="border border-slate-200 rounded-2xl bg-white p-4 md:p-5"
                  >
          ...
          {registrationType === "individual" && (
            <>
              ...
              <div className="bg-white rounded-3xl shadow-sm border border-slate-100 p-6 md:p-8">
                ...
                <p className="text-sm text-slate-500 mt-1">
                  Please provide your complete personal details as per
                  government ID
                </p>
              ...
              <div className="bg-white rounded-3xl shadow-sm border border-slate-100 p-6 md:p-8 space-y-6">
                <div>
                  ...
                  <p className="text-sm text-slate-500 mt-1">
                    Help us better understand your running profile
                  </p>
                ...
                <div className="mt-4 rounded-2xl bg-cyan-50/60 border border-cyan-100 p-4 md:p-5">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-200 px-3 py-2 text-sm shadow-sm focus:border-teal-500 focus:ring-2 focus:ring-teal-500/50 bg-white"
                  />
                </div>
              </div>
              ...
              <div className="bg-white rounded-3xl shadow-sm border border-slate-100 p-6 md:p-8">
                ...
                <p className="text-sm text-slate-500 mt-1">
                  Choose your preferences and additional services
                </p>
